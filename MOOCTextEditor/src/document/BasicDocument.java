...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		String[] result = super.getText().split("[^a-zA-Z]+");
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		String []result = super.getText().split("[!?.]+");
		List<String> list = new ArrayList<>();
		for(String s : result){
			if(s.length() > 0){
				list.add(s);
	...
	public int getNumSyllables()
	{
		...
		String[] words = super.getText().split("[^a-zA-Z]+");
		int count = 0;
		for(String word : words){
			int k = super.countSyllables(word);
	...
	public static void main(String[] args)
	{
		...
		String text4 = new String("My ");
		text4 = text4 + new String("String");
		System.out.print(text4 + "\n");
		String s = "%one%%two%%%three%%%%";
		String[] sb1 = s.split("%+");
		String[] sb2 =s.split("[a-z]+");
		String[] sb3 =s.split("one|two|three");
		String[] sb4 =s.split("[one,two,three]");
		int a = 1;
	}
