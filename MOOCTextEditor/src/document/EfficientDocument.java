...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		int numOfWord = 0, numOfSentences = 0, numOfSyllables = 0;
		for(String tok : tokens){
			if(this.isWord(tok)){
				numOfWord += 1;
				numOfSyllables += this.countSyllables(tok);
			}
		}
		...
		this.numWords = numOfWord;
		this.numSentences = numOfSentences;
		this.numSyllables = numOfSyllables;
	}
